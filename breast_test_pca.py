...
X_test_scaled = X_test_scaled @ W  ## Your code here

# Do a prediction using the test data
y_pred = svc_classifier.predict(X_test_scaled)  ## Your code here
...
ax.set_title("Breast Cancer Confusion Matrix (testing data with PCA)")
